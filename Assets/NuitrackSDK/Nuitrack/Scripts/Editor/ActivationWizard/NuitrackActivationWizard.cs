    ...
    public class NuitrackActivationWizard : EditorWindow
    {
        ...
        void UpdateSensorState()
        {
            if (!EditorApplication.isPlaying)
                haveDivices = NuitrackChecker.HaveConnectDevices(out devicesNames, out deviceActivations);
        }
        ...
        void OnEnable()
        {
            ...
            bool withDeviceInfo = !EditorApplication.isPlaying && (!haveDivices || haveActivated);
